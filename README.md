...
| `terminationGracePeriod`                            | Seconds the MarkLogic Pod terminiate gracefully                                                                                                                                        | `120`                      |
...
| `bootstrapHostName`                                 | Host name of MarkLogic bootstrap host (to join a cluser)                                                                                                                               | `""`                       |
...
| `initContainerImage.tag`                            | Image tag for initContainer image                                                                                                                                                      | `curlimages/curl`          |
...
| `logCollection.resources.requests.cpu`              | The requested cpu resource for the fluent-bit containrer                                                                                                                               | `100m`                     |
| `logCollection.resources.requests.memory`           | The requested memory resource for the fluent-bit container                                                                                                                             | `128Mi`                    |
| `logCollection.resources.limits.cpu`                | The cpu resource limit for the fluent-bit containrer                                                                                                                                   | `100m`                     |
...
| `haproxy.enabled`                                   | Enable this parameter to enable the HAProxy Load Balancer for MarkLogic Server                                                                                                         | `false`                    |
...
| `haproxy.stats.enabled`                             | Enable this parameter to enable ths stats page for HAProxy                                                                                                                             | `false`                    |
| `haproxy.stats.port`                                | Port for stats page                                                                                                                                                                    | `1024`                     |
| `haproxy.stats.auth.enabled`                        | Enable this parameter to enable the basic auth for stats page                                                                                                                          | `false`                    |
...
| `haproxy.tls.enabled`                               | Enable this parameter to enable TLS for HAProxy                                                                                                                                        | `false`                    |
...
| `haproxy.resources.requests.cpu`                    | The requested cpu resource for the HAProxy containrer                                                                                                                                  | `250m`                     |
| `haproxy.resources.requests.memory`                 | The requested memory resource for the HAProxy containrer                                                                                                                               | `128Mi`                    |
| `haproxy.resources.limits.cpu`                      | The cpu resource limit for the HAProxy containrer                                                                                                                                      | `250m`                     |
