...
4. The latest released version of fluent/fluent-bit:3.1.1 has known high and critical security vulnerabilities. Should you decide to enable the log collection feature, please choose the latest fluent-bit or any other image as per your requirements with no vulnerabilities. We will provide updates and mitigation strategies as soon as more information becomes available about these vulnerabilities in fluent-bit.
