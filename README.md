...
4. The latest released version of fluent/fluent-bit:3.1.1 has known high and critical security vulnerabilities. Should you decide to enable the log collection feature, please choose and deploy the latest fluent-bit or an alternate image as per your requirements with no vulnerabilities.
