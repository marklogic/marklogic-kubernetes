...
| `haproxy.DefaultAppServerPath.appservices`          | Path used to expose MarkLogic App-Services  App-Server                              | `""`                     |
| `haproxy.DefaultAppServerPath.admin`                | Path used to expose MarkLogic Admin App-Server                                  | `""`                     |
| `haproxy.DefaultAppServerPath.manage`               |Path used to expose the MarkLogic Manage App-Server                                                                                                                             | `""`                     |
| `haproxy.httpports`                                     | HTTP Ports and load balancing type configuration for HAproxy                                                                                                                                | `[]`                       |
